...
const Services = () => {
  ...
  return (
    <section className='w-full px-6 sm:px-8 md:px-12'>
      ...
      <div className='w-full flex flex-col md:flex-row gap-10 lg:gap-0 items-center justify-between py-10 lg:py-20 lg:px-10'>
          <div className='flex flex-col gap-4'>
            <div className={`${active === 1 ? 'border bg-primary-50' : ''} flex flex-col gap-3 cursor-pointer p-6 w-full max-w-[500px]`}>
              <div className='flex items-start  gap-3'>
                <img src={`${active === 1 ? customize : customizeClosed}`} alt="customize icon" className='w-[20px]  md:w-[20px]'/>
            ...
            <div className={`${active === 2 ? 'border bg-primary-50' : ''} flex flex-col gap-3 cursor-pointer p-6 w-full max-w-[500px]`}>
              <div className='flex items-start  gap-3'>
                <img src={`${active === 2 ? tag : tagClosed}`} alt="customize icon" className='w-[20px] md:w-[20px]'/>
                <div className='flex flex-col w-full items-start gap-3 transition-all'>
                  <h1 
                    className={`font-semibold text-[1rem] lg:text-xl ${active === 2 ? 'text-primary-800' : 'text-neutral-100'}`}
            ...
            <div className={`${active === 3 ? 'border bg-primary-50' : ''} flex flex-col gap-3 cursor-pointer p-6 w-full max-w-[500px]`}>
              <div className='flex items-start  gap-3'>
                <img src={`${active === 3 ? charts : chartsClosed}`} alt="customize icon" className='w-[20px] mt-1 md:w-[20px] '/>
            ...
            <div className={`${active === 4 ? 'border bg-primary-50' : ''} flex flex-col gap-3 cursor-pointer p-6 w-full max-w-[500px]`}>
              <div className='flex items-start  gap-3'>
                <img src={`${active === 4 ? share : shareClosed}`} alt="customize icon" className='w-[20px] md:w-[20px] '/>
                <div className='flex flex-col w-full items-start gap-3'>
                  <h1 
                   className={`font-semibold text-[1rem] lg:text-xl ${active === 4 ? 'text-primary-800' : 'text-neutral-100'}`}
            ...
            <div className={`${active === 5 ? 'border bg-primary-50' : ''} flex flex-col gap-3 cursor-pointer p-6 w-full max-w-[500px]`}>
              <div className='flex items-start  gap-3'>
                <img src={`${active === 5 ? card : cardClosed}`} alt="customize icon" className='w-[20px] md:w-[20px] '/>
                <div className='flex flex-col w-full items-start gap-3'>
                  <h1 
                   className={`font-semibold text-[1rem] lg:text-xl ${active === 5 ? 'text-primary-800' : 'text-neutral-100'}`}
